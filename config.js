module.exports = {
	...
	adminId: "778148891652259860", //- Replace UserId with the Discord ID of the admin of the bot
	...
	supportServer: "https://dsc.gg/imdoremon", //- Support Server Link
	Issues: "https://dsc.gg/imdoremon", //- Bug Report Link
	...
	cookieSecret: "imdoremon", //- Cookie Secret
	website: "Not available ", //- without the / at the end
	// You need a lavalink server for this bot to work!!!!
	// Lavalink server; public lavalink -> https://lavalink-list.darrennathanael.com/; create one yourself -> https://darrennathanael.com/post/how-to-lavalink
	nodes: [
		{
			identifier: "Main Node", //- Used for indentifier in stats commands.
			host: "54.38.198.23", //- The host name or IP of the lavalink server.
